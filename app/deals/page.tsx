...
export default function DealsPage() {
  ...
  async function fetchAll() {
    ...
    const DETAIL_ONLY_COLS = new Set(['video_url', 'minutes_text'])
    if (colRes.data) setTobCols(colRes.data.filter((c: ColumnConfig) => c.table_type === 'tob' && c.visible && !DETAIL_ONLY_COLS.has(c.column_key)))
